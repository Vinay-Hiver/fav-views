...
import AllViewsPanelOption3 from './AllViewsPanelOption3';
import { ViewTypeIcon } from '../components/viewIcons';
...
const MainSidebarPanelOption3 = ({ activeFilter, onFilterChange, activeRole }) => {
  ...
  const renderNestedItems = (inboxName) => {
    const { views, favouriteIds: favouriteIdsByRole } = viewsByInbox[inboxName];
...
export default MainSidebarPanelOption3;
