...
// Kebab menu option icons — placeholders until the menu gets a real design pass.
export const UsersStarIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M17 21v-1a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v1"></path>
    <circle cx="9" cy="7" r="4"></circle>
    <path d="M18.5 12.5l.94 1.9 2.1.3-1.52 1.48.36 2.1-1.88-1-1.88 1 .36-2.1-1.52-1.48 2.1-.3z"></path>
  </svg>
);

// Untitled UI "heart-circle" glyph — shown on a view's row icon while it's
// a Team Favourite, to visually flag it as team-pinned.
export const HeartCircleIcon = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="12" r="10"></circle>
    <path d="M15.7 9.3c-1 0-1.85.6-2.2 1.46a2.38 2.38 0 0 0-2.2-1.46A2.4 2.4 0 0 0 8.9 11.7c0 2.5 3.1 4.3 4.4 5.4 1.3-1.1 4.4-2.9 4.4-5.4a2.4 2.4 0 0 0-2.4-2.4Z"></path>
  </svg>
);
